...
%-------------------------------------------------------------------------------------------------------------------------------%
\newcommand{\set@fancychap@chName}[1][\@chapapp]{}%
\newcommand{\set@fancychap@chTitle}[1]{\CTV\FmTi{#1}}%
\newcommand{\set@fancychap@chNumbering}[1][\CNoV\thechapter]{}%
...
\newcommand{\set@fancychap@PetersLenny}{%
    ...
    \renewcommand{\DOCH}{%tweaks for 1--9 and A--Z
        ...
        \fi\fi
        \settowidth{\px}{\CNV\FmN{\bibname}}
            \addtolength{\px}{\tl}        %MOD change 2pt to \tl
            \settoheight{\py}{\CNV\FmN{\bibname}}
            \addtolength{\py}{1pt}
            \settowidth{\mylen}{\CNV\FmN{\bibname}\space\CNoV\thechapter}
            ...
            \parbox[b]{\textwidth}{%
                ...
                \raggedright\CNV\FmN{\bibname}\rule{\blrule}{\RW}\hskip\bl\CNoV\thechapter%MOD
            %\CNV\FmN{\bibname}\space\CNoV\thechapter                     %ORIGINAL
...
\newcommand{\set@fancychap@Lenny}{%
    \pagestyle{empty}%
        ...
        \ChNumVar{\fontsize{60}{62}\usefont{OT1}{ptm}{m}{n}\selectfont}%
        \ChTitleVar{\HUGE\mdseries\rmfamily}%\bfseries\rmfamily\scshape                                                                                                       \selectfont
        \ChRuleWidth{1.0pt}%
    \renewcommand{\DOTI}[1]{\raggedright\CTV\FmTi{##1}\par\nobreak\vskip 40\p@}%
    \renewcommand{\DOTIS}[1]{\raggedright\CTV\FmTi{##1}\par\nobreak\vskip 40\p@}%
    \renewcommand{\DOCH}{%
            \setlength{\px}{\widthof{\CNV\FmN{\bibname}}+2\p@}%\space\CNoV\thechapter
                \setlength{\py}{\heightof{\CNV\FmN{\bibname}}+1\p@}%\space\CNoV\thechapter
                \setlength{\mylen}{\widthof{\CNV\FmN{\bibname}}+1\p@}%\space\CNoV\thechapter
                \setlength{\pxx}{\widthof{}-1\p@}
        \setlength{\pyy}{\heightof{\CNoV\thechapter}-2\p@}%
                \setlength{\myhi}{\pyy-\py}%
        \par%
            \parbox[b]{\textwidth}{%
                \rule[\py]{\RW}{\myhi}\hskip -\RW% left/vrule
                \rule[\pyy]{\px}{\RW}\hskip -\px%top/hrule, from left corner to \bibname
                \raggedright\CNV\FmN{\bibname}\hskip1pt%%\space\CNoV\thechapter%
                \mghrulefill{\RW}%bottom/hrule/from \bibname
...
\newcommand{\set@fancychap@Sonny}{%
    ...
    \ChRuleWidth{0.5pt}
    \ChNameUpperCase
        \renewcommand{\DOCH}{\fncychap@dblhrule[5\p@]\CNV\FmN{\bibname}\par@nbskip{40\p@}}%\space \CNoV\thechapter
    \renewcommand{\DOTI}[1]{%
...
\newcommand{\set@fancychap@Bjornstrup}{%
    ...
    \renewcommand{\DOCH}{%
            \raggedleft\settowidth{\py}{\CNoV\thechapter}\addtolength{\py}{-10pt}\fboxsep=0pt% Amount of space by which the number is shifted right
            \raggedleft\colorbox[gray]{.85}{\rule{0pt}{40pt}\parbox[b]{\textwidth}{\hfill}}%
            \kern-\py\raise20pt\hbox{\color[gray]{.5}\CNoV\thechapter}\\%
    }
    \renewcommand{\DOTI}[1]{%
...
\newcommand{\set@fancychap@Glenn}{%
    ...
    \renewcommand{\DOCH}{%
            ...
            \raggedright\CNV\FmN{\bibname}\hskip 6pt%\space\CNoV\thechapter
...
\newcommand{\set@fancychap@Conny}{%
    ...
    \renewcommand{\DOCH}{%
            ...
            \mghrulefill{\RW}\par\nobreak\bigskip
            \CNV\FmN{\bibname}\space \CNoV\thechapter\par\nobreak\vskip -0.5\baselineskip\bigskip
    }
...
\newcommand{\set@fancychap@Bjarne}{%
    ...
    \ChNumVar{\raggedleft\Large\bfseries}
...
%-------------------------------------------------------------------------------------------------------------------------------%
\newcommand{\chapSonny}[0]{\set@fancychap@Sonny\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapSonny*[0]{\raggedleft\set@fancychap@Sonny\DOTIS{\RefsName}}
\newcommand{\chapLenny}[0]{\raggedleft\set@fancychap@Lenny\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapLenny*[0]{\raggedleft\set@fancychap@Lenny\DOTIS{\RefsName}}
\newcommand{\chapPetersLenny}[0]{\raggedleft\set@fancychap@PetersLenny\DOCH}
\WithSuffix\newcommand\chapPetersLenny*[0]{\raggedleft\set@fancychap@PetersLenny\DOTIS{\RefsName}}
\newcommand{\chapBjornstrup}[0]{\raggedleft\set@fancychap@Bjornstrup\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapBjornstrup*[0]{\raggedleft\set@fancychap@Bjornstrup\DOTIS{\RefsName}}
\newcommand{\chapGlenn}[0]{\raggedleft\set@fancychap@Glenn\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapGlenn*[0]{\raggedleft\set@fancychap@Glenn\DOTIS{\RefsName}}
\newcommand{\chapConny}[0]{\raggedleft\set@fancychap@Conny\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapConny*[0]{\raggedleft\set@fancychap@Conny\DOTIS{\RefsName}}
\newcommand{\chapRejne}[0]{\raggedleft\set@fancychap@Rejne\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapRejne*[0]{\raggedleft\set@fancychap@Rejne\DOTIS{\RefsName}}
\newcommand{\chapBjarne}[0]{\raggedleft\set@fancychap@Bjarne\DOCH\DOTI{\RefsName}}
\WithSuffix\newcommand\chapBjarne*[0]{\raggedleft\set@fancychap@Bjarne\DOTIS{\RefsName}}
